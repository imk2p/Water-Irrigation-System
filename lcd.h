...
#define LCD_E SBIT (PORTD, 3)					// Pin for LCD /E signal
//PIN (LCD_RW,		P, 5);					// not used
#define LCD_RS SBIT(PORTD, 2)					// Pin for LCD /E signal
/*
PIN (SEL0,			P1,0);
PIN (SEL1,			P1,1);
PIN (SEL2,			P1,2);
*/					// Add definitions for direction control
#define LCD_TRIS_E SBIT(DDRD, 3)					// Pin for LCD /E signal
//PIN (LCD_TRIS_RW,	TRISC, 4);
#define LCD_TRIS_RS SBIT(DDRD, 2)					// Pin for LCD /E signal
